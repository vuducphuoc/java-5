...
<div class="navbar navbar-expand-sm" id="navigator">
    <div class="container pl-0 pr-0">
        <div class="col-md-8">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-uppercase" href="#"> Hàng mới về </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="#">Sản phẩm bán chạy</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <c:forEach var="item" items="${listMenuItem}">
                            <a class="dropdown-item" href="<c:url value="/collections/${item.name.replace(' ','-').toLowerCase()};id=${item.id}"/>">${item.name}</a>
                        </c:forEach>
                    </div>
                </li>
        ...
        <div class="col-md-4 pl-5">
            <form class="input-group border pl-3 pr-3 align-items-center" action="<c:url value="/collections"/> " id="formSearch">
                <input class="form-control-plaintext form-control-sm" type="text" placeholder="Tìm kiếm..." id="inputSearch" name="txtSearch">
